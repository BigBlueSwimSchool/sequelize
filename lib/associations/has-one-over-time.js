...
/**
 * @mixin HasOneOverTime
 */
var HasOneOverTime = function(source, target, options) {
  Association.call(this);

  options = options || {};

  if (options.through === undefined || options.through === true || options.through === null) {
    throw new Error('HasOneOverTime must be given a through option, either a string or a model');
  }
  ...
  this.associationType = 'HasOneOverTime';
  this.source = source;
  this.target = target;
  ...
  _.each(this.target.associations, function(association) {
    if (association.associationType !== 'HasOneOverTime') return;
...
util.inherits(HasOneOverTime, Association);

// the id is in the target table
// or in an extra table which connects two tables
HasOneOverTime.prototype.injectAttributes = function() {
  var self = this;
  ...
  if (this.options.constraints !== false) {
    ...
    // But the for target attribute the previously defined option is the priority (since it could've been set by another HasOneOverTime call)
...
HasOneOverTime.prototype.get = function(instance, options) {
...
HasOneOverTime.prototype.injectGetter = function(obj) {
  var association = this;
...
HasOneOverTime.prototype.injectSetter = function(obj) {
  var association = this;
...
HasOneOverTime.prototype.injectCreator = function(obj) {
  var association = this;
...
module.exports = HasOneOverTime;
module.exports.HasOneOverTime = HasOneOverTime;
module.exports.default = HasOneOverTime;
